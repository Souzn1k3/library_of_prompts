        ...
        {wallet ? (
          <>
            ...
            >
              ...
              <div className="pointer-events-none absolute right-0 top-full z-[9999] mt-2 w-[min(21rem,88vw)] translate-y-1 rounded-xl border border-[rgba(15,23,42,0.12)] bg-white/96 p-3 shadow-[0_16px_34px_rgba(15,23,42,0.12)] opacity-0 transition duration-150 delay-0 group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-[500ms]">
                {renderRankHelp()}
              </div>
            </div>
            <div
