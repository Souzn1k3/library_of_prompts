    ...
    >
      ...
      <div className="pv-action-bar pv-action-bar-start mt-auto">
        {status === "loading" ? (
          ...
          <span className="inline-flex items-center rounded-full border border-[var(--pv-border-strong)] bg-[var(--pv-brand-soft)] px-3 py-2 text-sm font-medium text-[var(--pv-brand-strong)]">
            {t("plans.currentPlan")}
          </span>
        ) : isLowerOrEqual ? (
