      ...
      <div className="relative flex h-full flex-col gap-5">
        ...
        {item.owned ? (
          <button
            type="button"
            disabled
            className={`mt-auto inline-flex min-h-[2.9rem] items-center justify-center rounded-[0.75rem] px-4 py-3 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-75 ${tone.button}`}
          >
            {t("store.owned")}
          </button>
        ) : soldOut ? (
          ...
          <button
            ...
            disabled={disabled}
            className={`mt-auto inline-flex min-h-[2.9rem] items-center justify-center gap-2 rounded-[0.75rem] px-4 py-3 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-75 ${tone.button}`}
          >
