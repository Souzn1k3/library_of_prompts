  ...
  return (
    <div className="min-w-0 max-w-sm space-y-7">
      <Link href="/" className="inline-flex w-fit items-center gap-4 rounded-2xl">
        <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[rgba(47,111,189,0.36)] bg-[var(--pv-brand)] text-sm font-bold tracking-[0.18em] text-white">
          PV
        </span>
