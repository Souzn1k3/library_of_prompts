...
export function FooterBrandBlock({ brandName, description }: FooterBrandBlockProps) {
  return (
    <div className="min-w-0 max-w-sm space-y-6">
      <Link href="/" className="inline-flex w-fit items-center gap-4 rounded-2xl">
        <span
          className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[var(--pv-border)] bg-white text-sm font-bold tracking-[0.18em] text-[var(--pv-brand-strong)]"
        >
          PV
        </span>
