...
export function Footer() {
  ...
  return (
    <footer className="mt-16 border-t border-slate-300/80 bg-[rgba(237,242,249,0.98)]">
      <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-6 border-t border-slate-300/80 py-6 md:flex-row md:items-center md:justify-between">
