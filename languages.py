...
TRANSLATIONS = {
    'ru': {
        'welcome': "👋 **Привет, {name}!**\n\nЯ помогу сделать твой промпт сильнее: найду слабые места, поставлю оценку от 1 до 10 и перепишу запрос так, чтобы ИИ отвечал точнее.\n\nКаталог готовых промптов находится на сайте Prompts Vault.",
        ...
        'catalog_ai_btn': "Проверить промпт",
        'prompt_submission_btn': "Отправка промптов",
        'opportunities_btn': "возможности",
        'search_btn': "🔍 Поиск 🔍",
        'tariffs_btn': "💎 Тарифы 💎",
        'missions_btn': "🎯 Миссии 🎯",
        'games_btn': "🎮 Игры 🎮",
        ...
        'qwen_btn': "Qwen AI 🇨🇳",
        'gemma_btn': "Google Gemma 4 31B 🇺🇸",
        'z_ai_btn': "Z AI 🇨🇳",
        'nemotron_btn': "NVIDIA Nemotron 🇺🇸",
        'gpt_oss_btn': "ChatGPT 🇺🇸",
        'deepseek_btn': "DeepSeek 🇨🇳",
        'kimi_btn': "Kimi 🇨🇳",
        ...
        "copy_improved_prompt_btn": "Скопировать улучшенный промпт",
        "improved_prompt_copy_title": "📋 Улучшенный промпт для копирования:",
        ...
        'premium_daily_send_5_ai': "Premium: отправить 5 сообщений ИИ",
        'premium_daily_use_search_2': "Premium: использовать поиск моделей 2 раза",
        'premium_daily_claim_streak': "Premium: продлить ударный режим",
        'premium_daily_prompt_battle': "Premium: пройти битву промптов",
    ...
    'en': {
        ...
        'catalog_ai_btn': "Check prompt",
        'prompt_submission_btn': "Prompt submission",
        'opportunities_btn': "opportunities",
        'search_btn': "🔍 Search 🔍",
        ...
        "copy_improved_prompt_btn": "Copy improved prompt",
        "improved_prompt_copy_title": "📋 Improved prompt to copy:",
        ...
        'premium_daily_send_5_ai': "Premium: send 5 AI messages",
        'premium_daily_use_search_2': "Premium: use model search 2 times",
        'premium_daily_claim_streak': "Premium: extend streak",
        'premium_daily_prompt_battle': "Premium: complete a prompt battle",
    ...
    'tt': {
        ...
        'catalog_ai_btn': "Промптны тикшерү",
        'prompt_submission_btn': "промптлар җибәрү",
        'opportunities_btn': "Минем мөмкинлекләр",
        'search_btn': "🔍 Эзләү 🔍",
        ...
        "copy_improved_prompt_btn": "Яхшыртылган промптны күчерү",
        "improved_prompt_copy_title": "📋 Күчерү өчен яхшыртылган промпт:",
        ...
        'premium_daily_send_5_ai': "Premium: ИИга 5 хәбәр җибәрү",
        'premium_daily_use_search_2': "Premium: модельләр эзләүне 2 тапкыр куллану",
        'premium_daily_claim_streak': "Premium: удар режимын дәвам итү",
        'premium_daily_prompt_battle': "Premium: промпт баттлын үтү",
