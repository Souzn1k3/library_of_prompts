                    ...
                    "steps": [
                        {
                            ...
                            "content": [
                                ...
                                tr(
                                    ...
                                    "Примеры работают не как образец для бездумного копирования, а как маяк. Google и Anthropic отдельно подчеркивают, что few-shot примеры помогают, когда они действительно похожи на вашу задачу и показывают нужную структуру ответа. Если пример нерелевантный, модель копирует шум, а не логику.",
