...
_MESSAGES: dict[SupportedLanguage, dict[str, str]] = {
    "en": {
        ...
        "errors.telegram_already_linked": "This Telegram account is already linked.",
        "errors.telegram_account_mismatch": "This account is already linked to another Telegram user.",
        "errors.telegram_login_not_configured": "Telegram login is currently unavailable.",
        "errors.telegram_auth_failed": "We couldn't verify your Telegram sign-in.",
        "errors.invalid_telegram_auth_state": "Telegram sign-in expired. Please try again.",
        ...
        "errors.learning_lesson_locked": "Complete previous lessons to unlock this lesson.",
    ...
    "ru": {
        ...
        "errors.telegram_already_linked": "Этот Telegram-аккаунт уже привязан.",
        "errors.telegram_account_mismatch": "Этот аккаунт уже привязан к другому Telegram-пользователю.",
        "errors.telegram_login_not_configured": "Вход через Telegram сейчас недоступен.",
        "errors.telegram_auth_failed": "Не удалось подтвердить вход через Telegram.",
        "errors.invalid_telegram_auth_state": "Сессия входа через Telegram истекла. Попробуйте снова.",
        ...
        "errors.learning_lesson_locked": "Завершите предыдущие уроки, чтобы открыть этот урок.",
    ...
    "tt": {
        ...
        "errors.telegram_already_linked": "Бу Telegram аккаунты инде беркетелгән.",
        "errors.telegram_account_mismatch": "Бу аккаунт инде башка Telegram кулланучысына беркетелгән.",
        "errors.telegram_login_not_configured": "Telegram аша керү хәзер вакытлыча эшләми.",
        "errors.telegram_auth_failed": "Telegram аша керүне раслап булмады.",
        "errors.invalid_telegram_auth_state": "Telegram аша керү сессиясе вакыты чыкты. Тагын бер кат сынагыз.",
        ...
        "errors.learning_lesson_locked": "Бу дәресне ачу өчен алдагы дәресләрне тәмамлагыз.",
