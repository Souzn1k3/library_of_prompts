...
os.environ.setdefault("TELEGRAM_LOGIN_CLIENT_ID", "pytest-telegram-client-id")
os.environ.setdefault("TELEGRAM_LOGIN_CLIENT_SECRET", "pytest-telegram-client-secret")
os.environ.setdefault("TELEGRAM_LOGIN_REDIRECT_URI", "http://test/api/v1/auth/telegram/callback")
os.environ.setdefault("TELEGRAM_REWARD_SIGNING_SECRET", "pytest-telegram-reward-signing-secret")
os.environ.setdefault("SITE_URL", "http://127.0.0.1:3000")
