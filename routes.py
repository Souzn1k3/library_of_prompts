...
# ==============================================================================
# КОНФИГУРАЦИЯ МОДЕЛЕЙ: СИСТЕМНЫЕ ПРОМПТЫ И ССЫЛКИ
# ==============================================================================
...
MODEL_CONFIGS = {
    "mistral": {
        ...
        "emoji": "🌪️",
        "system_prompt": """Ты выступаешь в роли эксперта по prompt engineering и анализу запросов к нейросетям.
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://mistral.ai
...
Формат ответа должен быть строго структурированным, с четкими заголовками для каждого раздела."""
    ...
    "qwen": {
        ...
        "website": "https://www.aliyun.com/product/tongyi",
        "emoji": "🤖",
        "system_prompt": """Ты выступаешь в роли эксперта по prompt engineering и анализу запросов к нейросетям.
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://www.aliyun.com/product/tongyi
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://www.nvidia.com/en-us/ai/
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://openai.com

Формат ответа должен быть строго структурированным, с четкими заголовками для каждого раздела."""
    },
    "gemini": {
        "model_name": "google/gemini-pro-1.5:free",
        "api_url": QWEN_API_URL,
        "api_key_var": "OPENROUTER_API_KEY",
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://deepmind.google/technologies/gemini/
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://www.anthropic.com/claude
...
8. Источник нейросети  
   - Укажи ссылку на официальный сайт нейросети: https://ai.meta.com/llama/
...
async def call_openrouter_model(api_url: str, api_key: str, model: str, user_text: str, system_prompt: str = None) -> str:
    ...
    # Формируем сообщения с системным промптом, если он указан
    messages = []
    if system_prompt:
